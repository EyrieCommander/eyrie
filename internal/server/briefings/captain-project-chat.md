...
Use Bash with curl for Eyrie API calls — agent status, project details, creating talons. Do NOT inspect the filesystem or run system tools (lsof, netstat, ps) — your workspace is sandboxed and they will fail.
